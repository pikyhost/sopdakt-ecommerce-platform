            ...
            ->schema([
                Section::make(__('landing_page.basic_information'))->schema([
                    TextInput::make('slug')
                        ...
                        ->label(__('landing_page.slug'))
                        ->required(),
                    TextInput::make('sku')
                        ->label(__('landing_page.sku'))
                        ->required(),
                    TextInput::make('meta_title')
                        ->label(__('landing_page.meta_title')),
                    Textarea::make('meta_description')
                        ->label(__('landing_page.meta_description')),
                    Textarea::make('meta_keywords')
                        ->label(__('landing_page.meta_keywords')),
                    Toggle::make('status')
                ...
                Section::make(__('landing_page.home_section'))->schema([
                    ...
                    Grid::make(2)->schema([
                        TextInput::make('home_cta_button_text')
                            ...
                            ->required(fn ($get) => $get('home_show_cta_button'))
                            ->visible(fn ($get) => $get('home_show_cta_button')),
                    ...
                    FileUpload::make('home_section_top_image')
                        ...
                        ->downloadable()
                        ->openable()
                        ->required(fn ($get) => $get('is_home_section_top_image'))
                        ->visible(fn ($get) => $get('is_home_section_top_image')),
                    ...
                    FileUpload::make('home_section_bottom_image')
                        ...
                        ->downloadable()
                        ->openable()
                        ->required(fn ($get) => $get('is_home_section_bottom_image'))
                        ->visible(fn ($get) => $get('is_home_section_bottom_image')),
                ])->collapsed(),
                ...
                Section::make(__('landing_page.about_section'))->schema([
                    ...
                    FileUpload::make('about_section_top_image')
                        ...
                        ->downloadable()
                        ->openable()
                        ->required(fn ($get) => $get('is_about_section_top_image'))
                        ->visible(fn ($get) => $get('is_about_section_top_image')),
                    ...
                    FileUpload::make('about_section_bottom_image')
                        ...
                        ->downloadable()
                        ->openable()
                        ->required(fn ($get) => $get('is_about_section_bottom_image'))
                        ->visible(fn ($get) => $get('is_about_section_bottom_image')),

                    Repeater::make('aboutItems')
                        ...
                        ->schema([
                            ...
                            Grid::make(2)->schema([
                                ...
                                TextInput::make('cta_button_text')
                                    ...
                                    ->required(fn ($get) => $get('cta_button'))
        ...
        return Tab::make(__('landing_page.product'))
            ...
            ->schema([
                Section::make(__('landing_page.criteria_section'))->schema([
                    ...
                    TextInput::make('after_discount_price')->label(__('landing_page.after_discount_price')), // <-- Not mandatory
                    TextInput::make('rating')->label(__('landing_page.rating'))->numeric(), // <-- Not mandatory

                    Grid::make()->schema([
                        Select::make('colors')
                            ->label(__('landing_page.colors'))
                            ->multiple()
                            ->options(Color::pluck('name', 'id'))
                            ->live()
                            ->afterStateUpdated(function (Get $get, Set $set) {
                                self::generateCombinations($get, $set);
                            }),

                        Select::make('sizes')
                            ->label(__('landing_page.sizes'))
                            ->multiple()
                    ...
                    Repeater::make('varieties')
                        ...
                        ->afterStateHydrated(function ($state, $set, $record) {
                            $set('varieties', self::loadExistingCombinations($record));
                        })
                        ->disableItemCreation()
                        ->disableItemDeletion()
                ])->collapsed(),
                ...
                Section::make(__('landing_page.bundles_section'))->schema([
                    Repeater::make('bundles')
                        ...
                        ->schema([
                            ...
                            TextInput::make('name_for_admin')->label(__('landing_page.name_for_admin')),
                            ...
                            Select::make('products')
                                ->maxItems(fn (Get $get) => ($get('bundle_type') === 'fixed_price') ? 10 : 1)
                ...
                Section::make(__('landing_page.products_section'))->schema([
                    ...
                    TextInput::make('product_title')
                        ->label(__('landing_page.title'))
                        ->required(fn ($get) => $get('is_products')),
                    ...
                    FileUpload::make('products_section_top_image')
                        ...
                        ->downloadable()
                        ->openable()
                        ->visible(fn ($get) => $get('is_products_section_top_image'))
                        ->required(fn ($get) => $get('is_products_section_top_image')),
                    ...
                    FileUpload::make('products_section_bottom_image')
                        ...
                        ->downloadable()
                        ->openable()
                        ->visible(fn ($get) => $get('is_products_section_bottom_image'))
                        ->required(fn ($get) => $get('is_products_section_bottom_image')),

                    Repeater::make('productsItems')
                        ...
                        ->schema([
                            ...
                            Grid::make(2)->schema([
                                TextInput::make('cat_buttom_text')
                                    ->label(__('landing_page.cta_button_text'))
                                    ->required(fn ($get) => $get('cat_bottom')),

                                TextInput::make('cat_buttom_link')
                                    ->label(__('landing_page.cta_button_link'))
                                    ->required(fn ($get) => $get('cat_bottom')),
                            ])->visible(fn ($get) => $get('cat_bottom')),
                        ])
                        ->columns(2),
                ])->collapsed(),
            ])
            ...
            ->schema([
                Section::make(__('landing_page.features_section'))->schema([
                    ...
                    TextInput::make('feature_title')
                        ->label(__('landing_page.title'))
                        ->required(fn ($get) => $get('is_features'))
                    ...
                    FileUpload::make('features3_section_top_image')
                        ...
                        ->downloadable()
                        ->openable()
                        ->required(fn ($get) => $get('is_features3_section_top_image'))
                        ->visible(fn ($get) => $get('is_features3_section_top_image')),
                    ...
                    FileUpload::make('features3_section_bottom_image')
                        ...
                        ->downloadable()
                        ->openable()
                        ->required(fn ($get) => $get('is_features3_section_bottom_image'))
                        ->visible(fn ($get) => $get('is_features3_section_bottom_image')),
                    ...
                    Grid::make(2)->schema([
                        TextInput::make('feature_cta_button_text')
                            ->label(__('landing_page.cta_button_text'))
                            ->required(fn ($get) => $get('is_feature_cta_button'))
                            ->visible(fn ($get) => $get('is_feature_cta_button')),
                ...
                Section::make(__('landing_page.features_1_section'))->schema([
                    ...
                    TextInput::make('feature1_title')
                        ->label(__('landing_page.title'))
                        ->required(fn ($get) => $get('is_features1'))
                    ...
                    FileUpload::make('features1_section_top_image')
                        ...
                        ->downloadable()
                        ->openable()
                        ->required(fn ($get) => $get('is_features1_section_top_image'))
                        ->visible(fn ($get) => $get('is_features1_section_top_image')),
                    ...
                    FileUpload::make('features1_section_bottom_image')
                        ...
                        ->downloadable()
                        ->openable()
                        ->required(fn ($get) => $get('is_features1_section_bottom_image'))
                        ->visible(fn ($get) => $get('is_features1_section_bottom_image')),
                    ...
                    Grid::make(2)->schema([
                        TextInput::make('feature1_cta_button_text')
                            ->label(__('landing_page.cta_button_text'))
                            ->required(fn ($get) => $get('is_feature1_cta_button'))
                            ->visible(fn ($get) => $get('is_feature1_cta_button')),
                ...
                Section::make(__('landing_page.features_2_section'))->schema([
                    ...
                    TextInput::make('feature2_title')
                        ->label(__('landing_page.title'))
                        ->required(fn ($get) => $get('is_features2'))
                    ...
                    FileUpload::make('features2_section_top_image')
                        ...
                        ->downloadable()
                        ->openable()
                        ->required(fn ($get) => $get('is_features2_section_top_image'))
                        ->visible(fn ($get) => $get('is_features2_section_top_image')),
                    ...
                    FileUpload::make('features2_section_bottom_image')
                        ...
                        ->downloadable()
                        ->openable()
                        ->required(fn ($get) => $get('is_features2_section_bottom_image'))
                        ->visible(fn ($get) => $get('is_features2_section_bottom_image')),
                    ...
                    Grid::make(2)->schema([
                        TextInput::make('feature2_cta_button_text')
                            ->label(__('landing_page.cta_button_text'))
                            ->required(fn ($get) => $get('is_feature2_cta_button'))
                            ->visible(fn ($get) => $get('is_feature2_cta_button')),
            ...
            ->schema([
                Section::make(__('landing_page.deal_of_the_week_section'))->schema([
                    ...
                    TextInput::make('deal_of_the_week_title')
                        ->label(__('landing_page.title'))
                        ->required(fn ($get) => $get('is_deal_of_the_week') === true),
                    ...
                    FileUpload::make('deal_of_the_week_section_top_image')
                        ...
                        ->downloadable()
                        ->openable()
                        ->storeFileNamesIn('deal_of_the_week_section_top_image_name')
                        ->visible(fn ($get) => $get('is_deal_of_the_week_section_top_image') && $get('is_deal_of_the_week'))
                        ->required(fn ($get) => $get('is_deal_of_the_week_section_top_image') && $get('is_deal_of_the_week')),
                    ...
                    FileUpload::make('deal_of_the_week_section_bottom_image')
                        ...
                        ->downloadable()
                        ->openable()
                        ->storeFileNamesIn('deal_of_the_week_section_bottom_image_name')
                        ->visible(fn ($get) => $get('is_deal_of_the_week_section_bottom_image') && $get('is_deal_of_the_week'))
                        ->required(fn ($get) => $get('is_deal_of_the_week_section_bottom_image') && $get('is_deal_of_the_week')),
                    ...
                    Repeater::make('deals')
                        ...
                        ->schema([
                            ...
                            DatePicker::make('date_of_birth')
                                ...
                                ->native(false)
                                ->visible(fn ($get) => $get('../is_deal_of_the_week') === true),
                ...
                Section::make(__('landing_page.why_choose_us_section'))->schema([
                    ...
                    TextInput::make('why_choose_us_title')
                        ->label(__('landing_page.title'))
                        ->required(fn ($get) => $get('is_why_choose_us') === true),
                    ...
                    FileUpload::make('why_choose_us_section_top_image')
                        ...
                        ->downloadable()
                        ->openable()
                        ->storeFileNamesIn('why_choose_us_section_top_image_name')
                        ->visible(fn ($get) => $get('is_why_choose_us_section_top_image') && $get('is_why_choose_us'))
                        ->required(fn ($get) => $get('is_why_choose_us_section_top_image') && $get('is_why_choose_us')),
                    ...
                    FileUpload::make('why_choose_us_section_bottom_image')
                        ...
                        ->downloadable()
                        ->openable()
                        ->storeFileNamesIn('why_choose_us_section_bottom_image_name')
                        ->visible(fn ($get) => $get('is_why_choose_us_section_bottom_image') && $get('is_why_choose_us'))
                        ->required(fn ($get) => $get('is_why_choose_us_section_bottom_image') && $get('is_why_choose_us')),
                    ...
                    FileUpload::make('why_choose_us_video')
                        ...
                        ->downloadable()
                        ->openable()
                        ->storeFileNamesIn('why_choose_us_video_name')
                        ->visible(fn ($get) => $get('is_why_choose_us') === true)
                        ->required(fn ($get) => $get('is_why_choose_us') === true),
                ...
                Section::make(__('landing_page.compare_section'))->schema([
                    ...
                    TextInput::make('compare_title')
                        ->label(__('landing_page.title'))
                        ->required(fn ($get) => $get('is_compare') === true),
                    ...
                    FileUpload::make('compares_section_top_image')
                        ...
                        ->downloadable()
                        ->openable()
                        ->storeFileNamesIn('compares_section_top_image_name')
                        ->visible(fn ($get) => $get('is_compares_section_top_image') && $get('is_compare'))
                        ->required(fn ($get) => $get('is_compares_section_top_image') && $get('is_compare')),
                    ...
                    FileUpload::make('compares_section_bottom_image')
                        ...
                        ->downloadable()
                        ->openable()
                        ->storeFileNamesIn('compares_section_bottom_image_name')
                        ->visible(fn ($get) => $get('is_compares_section_bottom_image') && $get('is_compare'))
                        ->required(fn ($get) => $get('is_compares_section_bottom_image') && $get('is_compare')),
                    ...
                    Repeater::make('compare_content')
                        ...
                        ->schema([
                            ...
                            TextInput::make('cta_button_text')
                                ->label(__('landing_page.cta_button_text'))
                                ->visible(fn ($get) => $get('cta_button') === true)
                                ->required(fn ($get) => $get('cta_button') && $get('../is_compare') === true),
                        ...
                        ->label(__('landing_page.content'))
                        ->createItemButtonLabel(__('landing_page.add_content'))
                        ->visible(fn ($get) => $get('is_compare') === true)
                        ->required(fn ($get) => $get('is_compare') === true),
                ])->collapsed(),
                ...
                Section::make(__('landing_page.feedbacks_section'))->schema([
                    ...
                    TextInput::make('feedback_title')
                        ->label(__('landing_page.title'))
                        ->required(fn ($get) => $get('is_feedbacks') === true),
                    ...
                    FileUpload::make('feedbacks_section_top_image')
                        ...
                        ->downloadable()
                        ->openable()
                        ->storeFileNamesIn('feedbacks_section_top_image_name')
                        ->visible(fn ($get) => $get('is_feedbacks_section_top_image') && $get('is_feedbacks'))
                        ->required(fn ($get) => $get('is_feedbacks_section_top_image') && $get('is_feedbacks')),
                    ...
                    FileUpload::make('feedbacks_section_bottom_image')
                        ...
                        ->downloadable()
                        ->openable()
                        ->storeFileNamesIn('feedbacks_section_bottom_image_name')
                        ->visible(fn ($get) => $get('is_feedbacks_section_bottom_image') && $get('is_feedbacks'))
                        ->required(fn ($get) => $get('is_feedbacks_section_bottom_image') && $get('is_feedbacks')),
                    ...
                    Repeater::make('feedbacks_content')
                        ...
                        ->label(__('landing_page.content'))
                        ->createItemButtonLabel(__('landing_page.add_content'))
                        ->visible(fn ($get) => $get('is_feedbacks') === true)
                        ->required(fn ($get) => $get('is_feedbacks') === true),
                ])->collapsed(),
                ...
                Section::make(__('landing_page.faq_section'))->schema([
                    ...
                    TextInput::make('faq_title')
                        ->label(__('landing_page.title'))
                        ->required(fn ($get) => $get('is_faq') === true),
                    ...
                    FileUpload::make('faq_section_top_image')
                        ...
                        ->downloadable()
                        ->openable()
                        ->storeFileNamesIn('faq_section_top_image_name')
                        ->visible(fn ($get) => $get('is_faq_section_top_image') && $get('is_faq'))
                        ->required(fn ($get) => $get('is_faq_section_top_image') && $get('is_faq')),
                    ...
                    FileUpload::make('faq_section_bottom_image')
                        ...
                        ->downloadable()
                        ->openable()
                        ->storeFileNamesIn('faq_section_bottom_image_name')
                        ->visible(fn ($get) => $get('is_faq_section_bottom_image') && $get('is_faq'))
                        ->required(fn ($get) => $get('is_faq_section_bottom_image') && $get('is_faq')),
                    ...
                    FileUpload::make('faq_image')
                        ...
                        ->downloadable()
                        ->openable()
                        ->storeFileNamesIn('faq_image_name')
                        ->visible(fn ($get) => $get('is_faq') === true)
                        ->required(fn ($get) => $get('is_faq') === true),
                ...
                Section::make(__('landing_page.footer_section'))->schema([
                    ...
                    TextInput::make('footer_title')
                        ->label(__('landing_page.title'))
                        ->required(fn ($get) => $get('is_footer') === true),
                    ...
                    FileUpload::make('footer_section_top_image')
                        ...
                        ->downloadable()
                        ->openable()
                        ->storeFileNamesIn('footer_section_top_image_name')
                        ->visible(fn ($get) => $get('is_footer_section_top_image') && $get('is_footer'))
                        ->required(fn ($get) => $get('is_footer_section_top_image') && $get('is_footer')),
                    ...
                    FileUpload::make('footer_section_bottom_image')
                        ...
                        ->downloadable()
                        ->openable()
                        ->storeFileNamesIn('footer_section_bottom_image_name')
                        ->visible(fn ($get) => $get('is_footer_section_bottom_image') && $get('is_footer'))
                        ->required(fn ($get) => $get('is_footer_section_bottom_image') && $get('is_footer')),
                    ...
                    FileUpload::make('footer_image')
                        ...
                        ->downloadable()
                        ->openable()
                        ->storeFileNamesIn('footer_image_name')
                        ->visible(fn ($get) => $get('is_footer') === true)
                        ->required(fn ($get) => $get('is_footer') === true),
                ])->collapsed(),
                ...
                Section::make(__('landing_page.counter_section'))->schema([
                    ...
                    TextInput::make('counter_section_cta_button_text')
                        ->label(__('landing_page.cta_button_text'))
                        ->required(fn ($get) => $get('is_counter_section') === true),
