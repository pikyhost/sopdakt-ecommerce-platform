...
class Setting extends Model implements HasMedia
{
    ...
    public static function getMaxCartQuantity(): int
    {
        return self::first()?->max_cart_quantity ?? 5;
    }

    public function registerMediaCollections(): void
    {
        $this->addMediaCollection('size_recommendation_popup')->singleFile()->acceptsMimeTypes(['image/jpeg', 'image/png', 'image/webp']);
    }

    public function getSizeGuideProductImageUrl(): ?string
    {
        return $this->getFirstMediaUrl('size_recommendation_popup') ?: null;
    }
