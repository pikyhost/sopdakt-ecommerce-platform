...
<div class="page-wrapper">
    ...
    <main class="main">
                ...
                <div class="row row-joined">
                    <div class="banner col-md-4">
                        <div class="banner-content text-left">
                            ...
                            <a href="demo11-shop.html" class="btn">Shop now <i
        ...
        <div class="container mb-4 mb-lg-6">
            ...
            <div class="row product-ajax-grid appear-animate" data-animation-name="fadeInUpShorter"
                    ...
                    <div class="product-default inner-quickview inner-icon">
                        <figure>
                            <a href="demo11-product.html">
                                <img src="assets/images/demoes/demo11/products/product-15.jpg" width="280"
                                     height="280" alt="product" />
                                <img src="assets/images/demoes/demo11/products/product-15-2.jpg" width="280"
                                     height="280" alt="product" />
                            </a>
                            ...
                            <div class="btn-icon-group">
                                <a href="demo11-product.html" class="btn-icon btn-add-cart"><i
                        ...
                        <div class="product-details">
                            <div class="category-wrap">
                                <div class="category-list">
                                    <a href="demo11-shop.html" class="product-category">category</a>
                                </div>
                                <a href="wishlist.html" title="Wishlist" class="btn-icon-wish"><i
                                        class="icon-heart"></i></a>
                            </div>
                            <h3 class="product-title"> <a href="demo11-product.html">Women Fashion-Black</a> </h3>
                ...
                <div class="col-sm-3 col-6">
                    <div class="product-default inner-quickview inner-icon">
                        <figure>
                            <a href="demo11-product.html">
                                <img src="assets/images/demoes/demo11/products/product-16.jpg" width="280"
                                     height="280" alt="product" />
                                <img src="assets/images/demoes/demo11/products/product-16-2.jpg" width="280"
                                     height="280" alt="product" />
                            </a>
                            <div class="btn-icon-group">
                        ...
                        <div class="product-details">
                            ...
                            <h3 class="product-title"> <a href="demo11-product.html">Men Glasses</a> </h3>
                            <div class="ratings-container">
                                <div class="product-ratings">
                                    <span class="ratings" style="width:100%"></span><!-- End .ratings -->
                                    <span class="tooltiptext tooltip-top"></span>
                ...
                <div class="col-sm-3 col-6">
                    <div class="product-default inner-quickview inner-icon">
                        <figure>
                            <a href="demo11-product.html">
                                <img src="assets/images/demoes/demo11/products/product-17.jpg" width="280"
                                     height="280" alt="product" />
                                <img src="assets/images/demoes/demo11/products/product-17-2.jpg" width="280"
                                     height="280" alt="product" />
                            </a>
                            <div class="label-group">
                                <div class="product-label label-sale">27%</div>
                        ...
                        <div class="product-details">
                            ...
                            <h3 class="product-title"> <a href="demo11-product.html">Ray Ban 5228</a> </h3>
                            <div class="ratings-container">
                                <div class="product-ratings">
                                    <span class="ratings" style="width:100%"></span><!-- End .ratings -->
                                    <span class="tooltiptext tooltip-top"></span>
                ...
                <div class="col-sm-3 col-6">
                    <div class="product-default inner-quickview inner-icon">
                        <figure>
                            <a href="demo11-product.html">
                                <img src="assets/images/demoes/demo11/products/product-18.jpg" width="280"
                                     height="280" alt="product" />
                                <img src="assets/images/demoes/demo11/products/product-18-2.jpg" width="280"
                                     height="280" alt="product" />
                            </a>
                            <div class="btn-icon-group">
                                <a href="#" class="btn-icon btn-add-cart product-type-simple"><i
                        ...
                        <div class="product-details">
                            ...
                            <h3 class="product-title"> <a href="demo11-product.html">Masrinna Ankle Fashion</a>
                            </h3>
                            <div class="ratings-container">
                                <div class="product-ratings">
                                    <span class="ratings" style="width:100%"></span><!-- End .ratings -->
            ...
            <a class="btn btn-dark btn-lg btn-center loadmore" href="ajax/demo11-ajax-products.html">Load
                More...</a>
        ...
        <div class="container mb-2 mb-lg-4 appear-animate" data-animation-name="fadeIn" data-animation-delay="100">
            ...
            <div class="owl-carousel owl-theme pb-2 mb-2" data-owl-options="{
                ...
                <div class="product-default inner-quickview inner-icon">
                    <figure>
                        <a href="demo11-product.html">
                            <img src="assets/images/demoes/demo11/products/product-19.jpg" width="380" height="380"
                                 alt="Product" />
                            <img src="assets/images/demoes/demo11/products/product-19-2.jpg" width="380"
                    ...
                    <div class="product-details">
                        ...
                        <h3 class="product-title"> <a href="demo11-product.html">Product Brown Bag</a> </h3>
                        <div class="ratings-container">
                            <div class="product-ratings">
                                <span class="ratings" style="width:100%"></span><!-- End .ratings -->
                                <span class="tooltiptext tooltip-top"></span>
                ...
                <div class="product-default inner-quickview inner-icon">
                    <figure>
                        <a href="demo11-product.html">
                            <img src="assets/images/demoes/demo11/products/product-20.jpg" width="380" height="380"
                                 alt="Product" />
                            <img src="assets/images/demoes/demo11/products/product-20-2.jpg" width="380"
                                 height="380" alt="Product" />
                        </a>
                        <div class="btn-icon-group">
                            <a href="demo11-product.html" class="btn-icon btn-add-cart"><i
                    ...
                    <div class="product-details">
                        ...
                        <h3 class="product-title"> <a href="demo11-product.html">Women Shoes</a> </h3>
                        <div class="ratings-container">
                            <div class="product-ratings">
                                <span class="ratings" style="width:100%"></span><!-- End .ratings -->
                                <span class="tooltiptext tooltip-top"></span>
                ...
                <div class="product-default inner-quickview inner-icon">
                    <figure>
                        <a href="demo11-product.html">
                            <img src="assets/images/demoes/demo11/products/product-21.jpg" width="380" height="380"
                                 alt="Product" />
                            <img src="assets/images/demoes/demo11/products/product-21-2.jpg" width="380"
                                 height="380" alt="Product" />
                        </a>
                        <div class="label-group">
                            <div class="product-label label-hot">HOT</div>
                    ...
                    <div class="product-details">
                        ...
                        <h3 class="product-title"> <a href="demo11-product.html">Women Dress</a> </h3>
                        <div class="ratings-container">
                            <div class="product-ratings">
                                <span class="ratings" style="width:100%"></span><!-- End .ratings -->
                                <span class="tooltiptext tooltip-top"></span>
            ...
            <div class="row">
                <div class="col-md-4 pb-5 pb-md-0 appear-animate" data-animation-name="fadeIn"
                    ...
                    <div class="product-default left-details product-widget">
                        <figure>
                            <a href="demo11-product.html">
                                <img src="assets/images/demoes/demo11/products/small/product-1.jpg" width="68"
                                     height="69" alt="Product" />
                                <img src="assets/images/demoes/demo11/products/small/product-1-2.jpg" width="68"
                                     height="69" alt="Product" />
                            </a>
                        </figure>
                        <div class="product-details">
                            <h3 class="product-title"> <a href="demo11-product.html">Product Short Name</a> </h3>
                            <div class="ratings-container">
                                <div class="product-ratings">
                                    <span class="ratings" style="width:100%"></span><!-- End .ratings -->
                                    <span class="tooltiptext tooltip-top"></span>
                    ...
                    <div class="product-default left-details product-widget">
                        <figure>
                            <a href="demo11-product.html">
                                <img src="assets/images/demoes/demo11/products/small/product-2.jpg" width="68"
                                     height="69" alt="Product" />
                                <img src="assets/images/demoes/demo11/products/small/product-2-2.jpg" width="68"
                                     height="69" alt="Product" />
                            </a>
                        </figure>
                        <div class="product-details">
                    ...
                    <div class="product-default left-details product-widget">
                        <figure>
                            <a href="demo11-product.html">
                                <img src="assets/images/demoes/demo11/products/small/product-3.jpg" width="68"
                                     height="69" alt="Product" />
                                <img src="assets/images/demoes/demo11/products/small/product-3-2.jpg" width="68"
                                     height="69" alt="Product" />
                            </a>
                        </figure>
                        <div class="product-details">
                ...
                <div class="col-md-4 pb-5 pb-md-0 appear-animate" data-animation-name="fadeIn"
                    ...
                    <div class="product-default left-details product-widget">
                        <figure>
                            <a href="demo11-product.html">
                                <img src="assets/images/demoes/demo11/products/small/product-4.jpg" width="68"
                                     height="69" alt="Product" />
                                <img src="assets/images/demoes/demo11/products/small/product-4-2.jpg" width="68"
                                     height="69" alt="Product" />
                            </a>
                        </figure>
                        <div class="product-details">
                    ...
                    <div class="product-default left-details product-widget">
                        <figure>
                            <a href="demo11-product.html">
                                <img src="assets/images/demoes/demo11/products/small/product-5.jpg" width="68"
                                     height="69" alt="Product" />
                                <img src="assets/images/demoes/demo11/products/small/product-5-2.jpg" width="68"
                                     height="69" alt="Product" />
                            </a>
                        </figure>
                        <div class="product-details">
                    ...
                    <div class="product-default left-details product-widget">
                        <figure>
                            <a href="demo11-product.html">
                                <img src="assets/images/demoes/demo11/products/small/product-6.jpg" width="68"
                                     height="69" alt="Product" />
                                <img src="assets/images/demoes/demo11/products/small/product-6-2.jpg" width="68"
                                     height="69" alt="Product" />
                            </a>
                        </figure>
                        <div class="product-details">
                ...
                <div class="col-md-4 pb-5 pb-md-0 appear-animate" data-animation-name="fadeIn"
                    ...
                    <div class="product-default left-details product-widget">
                        <figure>
                            <a href="demo11-product.html">
                                <img src="assets/images/demoes/demo11/products/small/product-7.jpg" width="68"
                                     height="69" alt="Product" />
                                <img src="assets/images/demoes/demo11/products/small/product-7-2.jpg" width="68"
                                     height="69" alt="Product" />
                            </a>
                        </figure>
                        <div class="product-details">
                    ...
                    <div class="product-default left-details product-widget">
                        <figure>
                            <a href="demo11-product.html">
                                <img src="assets/images/demoes/demo11/products/small/product-8.jpg" width="68"
                                     height="69" alt="Product" />
                                <img src="assets/images/demoes/demo11/products/small/product-8-2.jpg" width="68"
                                     height="69" alt="Product" />
                            </a>
                        </figure>
                        <div class="product-details">
                    ...
                    <div class="product-default left-details product-widget">
                        <figure>
                            <a href="demo11-product.html">
                                <img src="assets/images/demoes/demo11/products/small/product-9.jpg" width="68"
                                     height="69" alt="Product" />
                                <img src="assets/images/demoes/demo11/products/small/product-9-2.jpg" width="68"
                                     height="69" alt="Product" />
                            </a>
                        </figure>
                        <div class="product-details">
