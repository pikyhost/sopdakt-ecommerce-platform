...
<div class="container">
    <div class="header">
        <h1>دعوة للانضمام إلى {{ config('app.name') }}</h1>
    </div>
    <div class="content">
        <p>مرحباً،</p>
        <p>لقد تمت دعوتك للانضمام إلى {{ config('app.name') }} كـ
            {{ \App\Enums\UserRole::getLabelFor($invitation->role->name) }}.</p>
        <p>اضغط على الزر أدناه لقبول الدعوة:</p>
