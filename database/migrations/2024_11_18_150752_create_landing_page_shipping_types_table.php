...
return new class extends Migration
{
    ...
    {
        Schema::create('landing_page_shipping_types', function (Blueprint $table) {
            ...
            $table->primary(['landing_page_id', 'shipping_type_id']);
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('landing_page_shipping_types');
    }
};
